...
#    st.write("Accelerate incident resolution with AI-powered log analysis")
    ...
    <div class="footer">
        Disclaimer: This response is generated by FastEye, an open-source AI model. While it provides helpful guidance, please verify the information independently. AI-generated outputs may occasionally be incomplete or inaccurate.\n
    ...
    if uploaded_file:
        ...
        duration_minutes = st.number_input("Duration (minutes):", min_value=1, max_value=1440, value=30)
        ...
        if analysis_result:
            ...
            st.info("Use the download button above or manually select and copy the text for email or notes.")
